...
int main(int argc, char** argv)
{
    ...
    for (ci=0; ci<config_vals[input] ; ci++)
    {
        ...
        for (hi=0; hi<len_h_field_vals; hi++)
        {
            ...
            pos_out_1 += sprintf(pos_out_1, "transient_O2_2D_%d_avalanche_cutoff_m_ratio.dat", L_vals[Li] );
            ...
            pos_out_2 += sprintf(pos_out_2, "limit_cycle_O2_2D_%d_avalanche_cutoff_m_ratio.dat", L_vals[Li] );
