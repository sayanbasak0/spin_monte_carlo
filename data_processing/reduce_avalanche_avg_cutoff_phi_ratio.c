        ...
        for (hi=0; hi<len_h_field_vals; hi++)
        {
            ...
            for (i_loop=0; i_loop<=loop_no; i_loop++)
            {
                ...
                for (j_array=0; j_array<nth_loop_array_size[i_loop]; j_array++)
                {
                    ...
                    double m_x_sq = (mx[i_loop][j_array] + del_mx[i_loop][j_array])*(mx[i_loop][j_array] + del_mx[i_loop][j_array]) + (mx[i_loop][j_array])*(mx[i_loop][j_array]);
                    double m_y_sq = (my[i_loop][j_array] + del_my[i_loop][j_array])*(my[i_loop][j_array] + del_my[i_loop][j_array]) + (my[i_loop][j_array])*(my[i_loop][j_array]);
                    double m_sq_avg = m_x_sq + m_y_sq;
                    ...
                    dmx_sq_avg[i_loop] += del_mx_sq/m_avg_sq ;
                    dmy_sq_avg[i_loop] += del_my_sq/m_avg_sq ;
                    dm_sq_avg[i_loop] += del_m_sq/m_avg_sq ;
                    dmx_abs_avg[i_loop] += del_mx_abs/sqrt(m_avg_sq) ;
                    dmy_abs_avg[i_loop] += del_my_abs/sqrt(m_avg_sq) ;
                    dm_abs_avg[i_loop] += del_m_abs/sqrt(m_avg_sq) ;
                }
            ...
            pos_out_1 += sprintf(pos_out_1, "transient_O2_2D_%d_avalanche_cutoff.dat", L_vals[Li] );
            ...
            pos_out_2 += sprintf(pos_out_2, "limit_cycle_O2_2D_%d_avalanche_cutoff.dat", L_vals[Li] );
