...
int main(int argc, char** argv)
{
    ...
    for (ci=0; ci<config_vals[input] ; ci++)
    {
        ...
        pos_in_1 += sprintf(pos_in_1, "transient_O2_2D_%d_reduced_cutoff.dat", L_vals[Li] );
        ...
        pos_in_2 += sprintf(pos_in_2, "limit_cycle_O2_2D_%d_reduced_cutoff.dat", L_vals[Li] );
    ...
    pos_out_1 += sprintf(pos_out_1, "transient_O2_2D_%d_dis_avg_cutoff.dat", L_vals[Li] );

    pFile_output_1 = fopen(output_file_1, "a");
    
    char output_file_2[256];
    char *pos_out_2 = output_file_2;
    pos_out_2 += sprintf(pos_out_2, "limit_cycle_O2_2D_%d_dis_avg_cutoff.dat", L_vals[Li] );

    pFile_output_2 = fopen(output_file_2, "a");
    
    char output_file_3[256];
    char *pos_out_3 = output_file_3;
    pos_out_3 += sprintf(pos_out_3, "total_O2_2D_%d_dis_avg_cutoff.dat", L_vals[Li] );
