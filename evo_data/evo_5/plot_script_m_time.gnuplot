...
set output "mag_time.png"

# Put X and Y labels
set xlabel "MC steps x(12800-updates+12800x[1,16]-averaging)"
set ylabel "|<M_x/M_y>|"
...
set title "Magnetisation vs MC sweeps (checkerboard) at T=0.6"
...
plot "M_C_0.600000_128x128_0.125000_0.500000.dat" u 1:3 w lp ls 1 t "h_x = R_x/4, M_x", \
"M_C_0.600000_128x128_0.062500_0.500000.dat" u 1:3 w lp ls 2 t "h_x = R_x/8, M_x", \
"M_C_0.600000_128x128_0.031250_0.500000.dat" u 1:3 w lp ls 3 t "h_x = R_x/16, M_x", \
"M_C_0.600000_128x128_0.125000_0.500000.dat" u 1:4 w lp ls 4 t "h_x = R_x/4, M_y", \
"M_C_0.600000_128x128_0.062500_0.500000.dat" u 1:4 w lp ls 5 t "h_x = R_x/8, M_y", \
"M_C_0.600000_128x128_0.031250_0.500000.dat" u 1:4 w lp ls 6 t "h_x = R_x/16, M_y", \
